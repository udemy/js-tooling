    ...
    invalid: [
        ...
        },
        {
            ...
            errors: [
                {
                    message:
                        'Please import OurComice from our/comice, not import { Comice } from pear',
                },
            ],
            filename: path.join(__dirname, 'example.js'),
            options,
        },
        {
            ...
            errors: [
                {
                    message:
                        'Please import { BlueBerry } from our/berry, not import { BlueBerry } from berry',
                },
            ],
            filename: path.join(__dirname, 'example.js'),
            options,
        },
        {
            ...
            errors: [
                {
                    message:
                        'Please import { BlackBerry } from our/berry, not import { BlackBerry } from berry',
                },
            ],
            filename: path.join(__dirname, 'example.js'),
            options,
